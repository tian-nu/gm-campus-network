...
class AppConfig:
    ...
    # 网络名称白名单
    enable_network_whitelist: bool = True  # 是否启用网络名称白名单
    network_name_whitelist: str = (
        "GM-living,"
        "东1-living,东2-living,东3-living,东4-living,"
        "东5-living,东6-living,东7-living"
    )  # 网络名称白名单，逗号分隔
