...
class ReconnectService:
    ...
    def __init__(
        ...
        network_whitelist_checker: Optional[Callable[[], bool]] = None
    ):
        """
        初始化重连服务
        ...
        Args:
            ...
            network_whitelist_checker: 网络白名单检查函数，返回 True 表示允许操作
        """
        self.logger = logging.getLogger(__name__)
        ...
        self.network_whitelist_checker = network_whitelist_checker
        ...
        while not self._stop_event.is_set():
            try:
                ...
                if (self.network_whitelist_checker
                    ...
                    self.logger.debug("当前网络不在白名单中，重连服务跳过本次检测")
